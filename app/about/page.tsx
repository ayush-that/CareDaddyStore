      ...
      <div className="p-6 space-y-8">
        ...
        <section>
          ...
          <div className="text-[#7a7a7a] space-y-4">
            <p>
              We are here to ensure that you and your loved ones stay healthy,
              active, and full of energy. Shop with ease for a healthier
              lifestyle, safe and convenient!
            </p>

            <p>
              Our mission is to help individuals access premium-quality generic
              and brand-name medications from trusted, globally recognized
              suppliers. Good health is not a luxury—it's the result of
              dedicated professionals and cutting-edge research, and we're here
        ...
        <section>
          ...
          <div className="text-[#7a7a7a] space-y-6">
            <div>
              ...
              <p>
                We partner only with reputable suppliers and provide thoroughly
                tested medications. All our products come with proper
                documentation and certifications to ensure the highest standards
                of quality. From world-renowned pharmaceutical institutions to
            ...
            <div>
              ...
              <p>
                Your privacy is our priority. We guarantee total anonymity and
                the safety of your personal and financial information. Every
                order is discreetly packaged as a gift, ensuring no one else
                knows what's inside. We're committed to protecting your secrets!
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="text-[#7a7a7a] space-y-4">
          ...
          <p className="italic">
            P.S. Have questions? Click "Callback" anytime, even if it's 3
            AM—we're always here to help!
          </p>
        </section>
      </div>
    </ClientWrapper>
